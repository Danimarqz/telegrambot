...
func registerCommands(registry *commands.Registry, collector *metrics.Collector) {
	...
	registry.Handle("docker_exec", "Ejecuta un comando en un contenedor Docker", commands.ScopeOwner, commands.DockerExec, commands.OwnerOnly())
	registry.Handle("swap_mc_server", "Modifica el servidor de minecraft en activo", commands.ScopeAdmin, commands.SwapMC, commands.AdminOnly())
